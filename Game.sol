...
contract GameContract {
    ...
    function createGame(bytes32[] memory _words, bytes32[] memory _meanings, string memory _thumb) public payable authenticatePlayer(msg.sender) checkCredit(GAME_CREATION_FEE) returns(uint256) {
